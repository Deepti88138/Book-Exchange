  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="stats">
          <div className="stat-box"><h2>35</h2><p>Total Borrowed Books</p></div>
          <div className="stat-box"><h2>22</h2><p>Total Lent Books</p></div>
          <div className="stat-box"><h2>3</h2><p>Active Loans</p></div>
        </div>

        <h2>Borrowed Books List</h2>
        <div className="book-grid">
          <div className="book-card">
            <img src="https://g.sdlcdn.com/imgs/k/r/l/Atomic-Habits-English-Paperback-by-SDL396648381-1-9177c.jpg" alt="Atomic Habits" />
            <div className="tags">
              <span className="tag borrowed">⌛ Borrowed</span>
              <span className="tag">Self Help</span>
            </div>
          </div>
          <div className="book-card">
            <img src="https://images-eu.ssl-images-amazon.com/images/I/617lxveUjYL._AC_UL210_SR210,210_.jpg" alt="The Alchemist" />
            <div className="tags">
        ...
        <div className="book-grid">
          ...
          <div className="book-card">
            <img src="https://images-eu.ssl-images-amazon.com/images/I/71-4MkLN5jL._AC_UL210_SR210,210_.jpg" alt="Educated" />
            <div className="tags">
              <span className="tag returned">✅ Returned</span>
